      ...
      <header className="header">
        ...
        <div className="header-search">
          <div className="search-input-wrapper">
            ...
            />
            <svg className="dandruff-icon">
              <use xlinkHref="#dandruff-icon" />
            </svg>
          </div>
        </div>

        {/* Іконки кошик + адмін (десктоп) */}
        <div className="header-basket">
          <Link to="/cart" className="basket-btn" style={{ position: 'relative' }} title="Кошик">
            <svg className="basket-icon">
              <use xlinkHref="#basket-icon" />
            </svg>
            {cartItems.length > 0 && (
          ...
          <Link to="/admin" className="admin-btn" title="Адмінпанель">
            <svg className="admin-icon">
              <use xlinkHref="#admin-icon" />
            </svg>
          </Link>
        </div>

        {/* Мобільна права частина: кошик + бургер */}
        ...
        <div className={`mobile-menu-drawer ${isMobileMenuOpen ? 'mobile-menu-drawer--open' : ''}`}>
          ...
          <nav className="mobile-nav">
            <NavLink to="/" className="mobile-nav-link" onClick={() => { setSearchQuery(''); closeMobileMenu(); }}>
              Головна
            </NavLink>
            <NavLink to="/catalog" className="mobile-nav-link" onClick={() => { setSearchQuery(''); closeMobileMenu(); }}>
              Каталог
            </NavLink>

            {/* Категорії у мобільному меню */}
            <div className="mobile-categories">
              {['Кераміка', 'Текстиль', 'Дерево', 'Шкіра', 'Прикраси', 'Дім', 'Скло', 'Мистецтво'].map((category) => (
                <span 
                  key={category} 
            ...
            <NavLink to="/markets" className="mobile-nav-link" onClick={closeMobileMenu}>
              Магазини
            </NavLink>
            <NavLink to="/admin" className="mobile-nav-link" onClick={closeMobileMenu}>
              Адмінпанель
            </NavLink>
            <a href="#" className="mobile-nav-link" onClick={openModal}>
              Зв'язатися з нами
            </a>
          </nav>
        </div>
          ...
          <div className="footer-text-cont">
            ...
            <div className="footer-images">
              <a href="https://www.facebook.com/" className="social-link">
                <svg className="social-icon"><use xlinkHref="#facebook-icon" /></svg>
              </a>
              <a href="https://www.instagram.com/" className="social-link">
                <svg className="social-icon"><use xlinkHref="#instagram-icon" /></svg>
              </a>
              <a href="https://web.telegram.org/a/" className="social-link">
                <svg className="social-icon"><use xlinkHref="#telegram-icon" /></svg>
              </a>
            </div>
          </div>
          ...
          <div className="footer-list">
            ...
            <div className="list">
              <div className="list-row">
                <a href="mailto:info@handcraft.ua" className="contact-link">
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="contact-form">
              ...
              <div className="form-group">
                ...
                <textarea rows="4" placeholder="Ваше питання..." required></textarea>
              </div>
              <button type="submit" className="submit-btn" onClick={(e) => { e.preventDefault(); alert('Дякуємо! Повідомлення надіслано.'); closeModal(); }}>
                Надіслати
              </button>
            </form>
          </div>
